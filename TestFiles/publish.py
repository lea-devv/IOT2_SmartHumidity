...
while True:
    ...
    if humidity is not None and temperature is not None:   #kun send data når værdierne ikke er 0.
        ...
        publish.single("window_command", "open" , hostname="4.231.174.166")  #Her kan bruges publish single og mulitple. Brug paho til bestemt topic, json sætter payload ind, bestem hvilkem host du vil publishe til via deres ip-adresse
